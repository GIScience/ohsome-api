...
public class AreaController {
  ...
  @ApiImplicitParams({
      ...
      @ApiImplicitParam(name = "groupByKey", paramType = "form", dataType = "string",
          defaultValue = "addr:postcode", required = true, value = ParameterDescriptions.KEYS_DESCR),
  ...
  @ApiImplicitParams({
      ...
      @ApiImplicitParam(name = "keys2", paramType = "form", dataType = "string",
          defaultValue = "building", required = true, value = ParameterDescriptions.KEYS_DESCR),
