...
public class AreaController {
  ...
  public ShareGroupByBoundaryResponse getAreaShareGroupByBoundary(
    ...
    // return
    // ElementsRequestExecutor.executeLengthPerimeterAreaShareGroupByBoundary(RequestResource.AREA,
    // false,
  ...
  @ApiImplicitParams({
      @ApiImplicitParam(name = "types2", value = typesDescr, defaultValue = "relation",
          paramType = "query", dataType = "string", required = false),
  ...
  @ApiImplicitParams({
      ...
      @ApiImplicitParam(name = "groupByKey", paramType = "form", dataType = "string",
          defaultValue = "addr:postcode", required = true, value = keysDescr),
