package org.heigit.bigspatialdata.ohsome.oshdbRestApi.eventHolder;
...
public class EventHolderBean {
   ...
   * 
   * @param dbPath Path to the database where to perform the search.
   * @param keytablesPath Path to the keytables database.
