...
public class PerimeterController {
  ...
  public DefaultAggregationResponse getPerimeter(
    ...
    return executor.executeLengthPerimeterArea(RequestResource.PERIMETER, false, bboxes, bcircles,
  ...
  public DefaultAggregationResponse getAreaDensity(
    ...
    ElementsRequestExecutor executor = new ElementsRequestExecutor();
    return executor.executeLengthPerimeterAreaDensity(RequestResource.PERIMETER, false, bboxes,
        bcircles, bpolys, types, keys, values, userids, time, showMetadata);
  }
  ...
  public DefaultAggregationResponse postPerimeter(String bboxes, String bcircles, String bpolys,
    ...
    ElementsRequestExecutor executor = new ElementsRequestExecutor();
    return executor.executeLengthPerimeterArea(RequestResource.PERIMETER, true, bboxes, bcircles,
        bpolys, types, keys, values, userids, time, showMetadata);
  }
  ...
  public DefaultAggregationResponse postPerimeterDensity(String bboxes, String bcircles,
    ...
    ElementsRequestExecutor executor = new ElementsRequestExecutor();
    return executor.executeLengthPerimeterAreaDensity(RequestResource.PERIMETER, true, bboxes,
        bcircles, bpolys, types, keys, values, userids, time, showMetadata);
  }
