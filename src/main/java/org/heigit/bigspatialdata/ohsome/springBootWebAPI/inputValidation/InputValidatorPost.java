...
public class InputValidatorPost {
	 ...
	 * 
	 * @param content
	 *            AggregationContent object containing the provided parameters.
	 */
	...
	/**
	 * Checks and extracts the content of the given <code>BBox</code> array. This
	 * method should only be used for a POST request. This REST API follows the
	 * following format for defining a bounding box: minLon, minLat, maxLon, maxLat.
	 * This means that the first coordinate pair defines the lower left and the
	 * second pair the upper right point.
	 * 
	 * @param bBoxes
	 *            <code>BBox</code> array containing 1...n BBox objects.
	 */
	...
	/**
	 * Checks and extracts the content of the given bPoints array. Format: lon, lat,
	 * radius
	 * 
	 * @param bPoints
	 */
	 ...
	 * 
	 * @param bPolys
	 *            String array containing lon/lat coordinate pairs.
	 */
